...
- `[SOFT]` **이견 없을 작업에 권한/확인 질문 금지 — 자율 실행이 default** (count: 6+, since: 2026-04-09)
  ...
  - **박제 incidents (축 6건)**:
    ...
    - 2026-05-08 KST (카파시 비교 답변 / 옵시): Karpathy LLM Wiki ↔ vault ↔ OpenCrab 비교 답변에서 박제 액션을 (a) Decisions 박제 / (b) Lessons 박제 / (c) 박제 안 함 식 옵션 나열로 종결. 형 challenge: *"박제? vault 에 넣겠다는거야?"* (msg `1502287731194204240`). 옵시 자체 정정 (msg `1502287938481029170`) — 자기 판정 (박제 안 함) + 근거 3건으로 전환. 학습: 박제 여부 판정도 옵션 나열 대상 X — 옵시 단독 큐레이터이므로 자기 판정 default.
